...
# USED TO BE -> This file is automatically generated by `rake rebuild`,
#   library is no longer maintained

# this file is manually edited by pulling down the NAPA database
#   and editing this file:


# last updated on 2/11/20
# https://nationalnanpa.com/reports/area_code_relief_planning.html

# this only updated the US country codes.  Everything else is < 2015.
# We generally only care if it's a USA phone number
...
module E164
  LookupTable = {
    ...
    # '1340' => ['US', 'United States'], us virgin islands
    ...
    '1456' => ['US', 'United States'], # international inbound - not technically US
    ...
    '1500' => ['US', 'United States'], # Non-geographic services
    ...
    '1533' => ['US', 'United States'], # Non-geographic services
    '1534' => ['US', 'United States'],
    '1539' => ['US', 'United States'],
    '1540' => ['US', 'United States'],
    '1541' => ['US', 'United States'],
    '1544' => ['US', 'United States'], # Non-geographic services
    ...
    '1566' => ['US', 'United States'], # Non-geographic services
    ...
    '1577' => ['US', 'United States'], # Non-geographic services
    ...
    # '1670' => ['US', 'United States'],
    # Commonwealth of the Northern Mariana Islands

    # '1671' => ['US', 'United States'], Guam
    '1678' => ['US', 'United States'],
    '1679' => ['US', 'United States'],
    '1680' => ['US', 'United States'],
    '1681' => ['US', 'United States'],
    '1682' => ['US', 'United States'],
    # '1684' => ['US', 'United States'], American Samoa
    '1689' => ['US', 'United States'],
    '1700' => ['US', 'United States'], # Interexchange Carrier Services
    ...
    # '1787' => ['US', 'United States'], Puerto Rico
    ...
    # '1900' => ['US', 'United States'], # Let's not allow ourselves to hit 1-900 numbers
    ...
    # '1911' => ['US', 'United States'], # Let's not spam 911 in any circumstance
    ...
    # '1939' => ['US', 'United States'], Puerto Rico
