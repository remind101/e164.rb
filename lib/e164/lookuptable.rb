# USED TO BE -> This file is automatically generated by `rake rebuild`, library is no longer maintained
# this file is manually edited by pulling down the NAPA database and editing this:
# https://nationalnanpa.com/reports/area_code_relief_planning.html

# this only updated the US country codes.  Everything else is < 2015.  We generally only care if it's a USA phone number
